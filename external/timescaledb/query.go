...
// QueryConfig TimescaleDB query configuration.
...
// QueryNode executes SQL query on TimescaleDB.
...
func (x *QueryNode) Desc() string {
	return "TimescaleDB client for querying time-series data. Routes to Success/Failure"
}
